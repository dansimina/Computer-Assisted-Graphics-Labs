    ...
    while (!quit) {
        ...
        if(SDL_WaitEvent(&currentEvent) != 0)
        {
            ...
            if(currentEvent.type == SDL_KEYDOWN)
            {
                ...
                {
                    case SDLK_UP: 
                        P1 = translate(250, 150) * scale(1.1, 1.1) * (translate(-250, -150) * P1);
                        P2 = translate(250, 150) * scale(1.1, 1.1) * (translate(-250, -150) * P2);
                        P3 = translate(250, 150) * scale(1.1, 1.1) * (translate(-250, -150) * P3);
                        P4 = translate(250, 150) * scale(1.1, 1.1) * (translate(-250, -150) * P4);
                        break;

                    case SDLK_DOWN:
                        P1 = translate(250, 150) * scale(0.9, 0.9) * (translate(-250, -150) * P1);
                        P2 = translate(250, 150) * scale(0.9, 0.9) * (translate(-250, -150) * P2);
                        P3 = translate(250, 150) * scale(0.9, 0.9) * (translate(-250, -150) * P3);
                        P4 = translate(250, 150) * scale(0.9, 0.9) * (translate(-250, -150) * P4);
                        break;
                        
                    case SDLK_RIGHT:  
                        P1 = translate(250, 150) * rotate(45) * (translate(-250, -150) * P1);
                        P2 = translate(250, 150) * rotate(45) * (translate(-250, -150) * P2);
                        P3 = translate(250, 150) * rotate(45) * (translate(-250, -150) * P3);
                        P4 = translate(250, 150) * rotate(45) * (translate(-250, -150) * P4);
                        break;
